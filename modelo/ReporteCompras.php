                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="page-header">
                                    <div class="row align-items-center">
                                        ...
                                        <div class="col-auto text-end float-end ms-auto download-grp">
                                            <button type="b
                                            utton" id="btnbuscar" class="btn btn-primary waves-effect waves-light">Buscar Reportes</button>
                                        </div>
                                    </div>
                                </div>
                                ...
                                $reportes = [
                                    ...
                                    ['id' => 3, 'nombre' => 'Reporte de Productos'],
                                    ['id' => 4, 'nombre' => 'Reporte de Pagos Personal'],
                                ];
                                ?>
